            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="color:#6B49D6; font-weight: bold; margin-bottom: 10px;">
                                Technology</h5>
                            <h3 class="card-title" style="color:black; font-weight: 600;">Masa Depan Digital:
                                Menjelajahi Dunia Teknologi yang Tak Terbatas</h3>
                            <p class="card-text" style="color:#827F7F; font-weight: 600;">Kami akan memperkenalkan Anda
            ...
            <div class="blog-card-container">
                <div class="blog-card">
                    ...
                    <div class="blog-content">
                        <span class="category"
                            style="color:#6B49D6; font-weight: bold; margin-bottom: 10px;">Hobby</span>
                        <h3 class="blog-title" style="color:black; font-weight: bold; margin-bottom: 10px;">Masa Depan
                            Digital: Menjelajahi Dunia Teknologi yang Tak Terbatas</h3>
                        <p class="blog-short-desc" style="color:#5C5C5C; font-weight: bold; margin-bottom: 10px;">Kami
                ...
                <div class="blog-card">
                    ...
                    <div class="blog-content">
                        ...
                        <h3 class="blog-title" style="color:black; font-weight: bold; margin-bottom: 10px;">Masa Depan
                            Digital: Menjelajahi Dunia Teknologi yang Tak Terbatas</h3>
                        <p class="blog-short-desc" style="color:#5C5C5C; font-weight: bold; margin-bottom: 10px;">Kami
                            akan memperkenalkan Anda pada inovasi-inovasi terbaru, tren yang sedang berkembang, .....
                        </p>
                    </div>
                    <div class="author-info">
                        <img src="./image/blog/Rectangle 21.png" class="author-img" alt="Author">
